...
L_ANNOUNCE_FP_CAST = "%s создаёт %s."
L_ANNOUNCE_FP_CLICK = "%s создаёт %s. Кликаем!"
...
L_COMBATTEXT_TEST_ENABLED = "Тестовый режим текста боя включён."
...
L_STATS_JUNK_CLEARED = "Список автопродажи очищен."
...
L_STATS_TOGGLE_TIME = "Местное/Серверное и 24-ч. время изменяются через меню часов."
...
L_STATS_CHANGE_SORTING = "[Гильдия] ПКМ — приглашения и шепот, СКМ — изменение сортировки, Shift+СКМ — обратный порядок."
L_STATS_OPEN_CHARACTER = "ЛКМ открывает окно персонажа."
L_STATS_RC_AUTO_REPAIRING1 = "ПКМ переключает автопочинку."
L_STATS_RC_AUTO_REPAIRING2 = "СКМ переключает автопочинку гильдии."
...
L_STATS_INSERTS_COORDS = "Shift+клик по модулю зоны или координат вставляет ваши текущие координаты в чат."
