...
local DB
local function Load()
	local SpellBinder = CreateFrame("Frame", "SpellBinder", PlayerSpellsFrame.SpellBookFrame, "ButtonFrameTemplate")
	...
	SpellBinder.OpenButton:SetScript("OnShow", function(self)
		...
		self:ClearAllPoints()
		self:SetPoint("TOPLEFT", PlayerSpellsFrame.SpellBookFrame, "TOPRIGHT", 4, 0)
