...
-- General options
L.general_subtext = "一般用戶界面設置，鍵入 /uihelp 獲取更多可用命令。"
L.general_welcome_message = "歡迎信息"
L.general_auto_scale = "自動UI縮放"
L.general_uiscale = "自定義UI縮放"
...
-- Skins options
L.skins = "界面美化"
L.skins_subtext = "對遊戲默認界面和單體插件界面進行美化"
L.skins_blizzard_frames = "美化暴雪默認界面"
L.skins_minimap_buttons = "小地圖插件圖標"
L.skins_subheader = "單體插件"
L.skins_minimap_buttons_mouseover = "滑鼠懸停顯示"
L.skins_bubbles = "美化聊天泡泡"

-- Unit Frames options
L.unitframe_subtext = "定制玩家/目標框架/其他框架"
...
L.unitframe_castbar_focus_type = "焦點施法條"
L.unitframe_castbar_focus_type_icon = "圖標"
L.unitframe_castbar_focus_type_bar = "圖標和施法條"
...
L.raidframe_plugins_debuffhighlight = "可驅散時高亮"
L.raidframe_plugins_debuffhighlight_icon = "顯示可驅散"
L.raidframe_plugins_debuffs = "團隊法術監視"
L.raidframe_plugins_debuffs_timer = "團隊減益時間"
L.raidframe_plugins_debuffs_filter = "啟用暴雪的減益效果過濾器" -- Needs review
L.raidframe_plugins_private_auras = "暴雪 '私人光環'"
L.raidframe_plugins_pvp_debuffs = "PvP DeBuff圖標"
L.raidframe_plugins_buffs = "團隊增益圖標 (按暴雪過濾列表)"
L.raidframe_plugins_buffs_timer = "增益時間"
...
-- Nameplate options
L.nameplate_subtext = "單位名條設置"
L.nameplate_enable = "單位名條增強"
L.nameplate_combat = "戰鬥中自動顯示單位名條"
L.nameplate_health_value = "生命值以百分比顯示"
...
L.nameplate_show_castbar_name = "法術名稱"
L.nameplate_cast_target = "顯示法術目標的名稱" -- Needs review
L.nameplate_class_icons = "PvP時顯示職業圖標"
L.nameplate_name_abbrev = "名字縮寫"
L.nameplate_short_name = "替換名稱"
L.nameplate_clamp = "貼邊顯示"
L.nameplate_clamp_desc = "當單位名條超出屏幕時仍貼邊顯示"
L.nameplate_track_debuffs = "顯示DeBuff(需要關閉名字縮寫)"
L.nameplate_track_buffs = "顯示可進攻驅散"
L.nameplate_auras_size = "圖標大小"
L.nameplate_healer_icon = "戰場中顯示治療職業圖標"
L.nameplate_totem_icons = "顯示敵對圖騰圖標"
L.nameplate_target_glow = "目標邊框高亮"
L.nameplate_only_name = "友方玩家只顯示名稱"
L.nameplate_click_through = "停用與友方名稱的互動" -- Needs review
...
L.nameplate_enhance_threat = "仇恨情況"
L.nameplate_good_color = "安全仇恨顏色"
L.nameplate_near_color = "臨界仇恨顏色"
L.nameplate_bad_color = "危險仇恨顏色"
L.nameplate_offtank_color = "副坦仇恨顏色"
L.nameplate_extra_color = "炸藥/惡意詞綴顏色"
L.nameplate_mob_color_enable = "副本中重要小怪著色"
L.nameplate_mob_color = "小怪顏色"
L.nameplate_mob_color_alt = "小怪顏色二"
L.nameplate_mob_color_list = "重要小怪名單"
L.nameplate_mob_color_list_desc = "NPC ID (用空格分開)"
...
L_GUI_GARRISON_ICON = "聖所報告圖標" -- Needs review
...
L.filger_show_aura_bar_player = "玩家Buff計時條"
...
L.automation_minimap_zoom = "按移速更改小地圖的縮放級別"
L.automation_reputation = "自動追蹤聲望"
...
L.pulsecooldown = "技能冷卻閃爍"
L.pulsecooldown_subtext = "顯示在屏幕中央"
L.pulsecooldown_enable = "技能冷卻閃爍提示"
L.pulsecooldown_size = "冷卻閃爍提示大小"
L.pulsecooldown_sound = "播放聲音提醒"
L.pulsecooldown_anim_scale = "動畫縮放"
