...
----------------------------------------------------------------------------------------
L_GUI_SET_SAVED_SETTINGS = "Set settings Per-Character"
L_GUI_SET_SAVED_SETTINGS_DESC = "Switch between a profile that applies to all characters and one that is unique to this character."
...
-- General options
L.general_subtext = "These settings control the general user interface settings. Type in chat '/uihelp' for help."
L.general_welcome_message = "Welcome message in chat"
L.general_auto_scale = "Auto UI Scale"
L.general_uiscale = "UI Scale (if auto-scale is disabled)"
...
L.general_minimize_mouseover = "Quest minimize button on mouseover"
...
L.font_quest_tracker_font_mult = "Quest text scale"
L.font_global_font = "Disable Pixel font"

-- Skins options
L.skins = "Stylization"
L.skins_subtext = "Change the appearance of the standard interface."
L.skins_blizzard_frames = "Enable styling Blizzard frames"
L.skins_minimap_buttons = "Enable styling addons icons on minimap"
L.skins_subheader = "Stylization of addons"
L.skins_ace3 = "Ace3"
L.skins_assistedcombat = "Simple Assisted Combat Icon"
...
L.skins_rarescanner = "RareScanner"
...
-- Unit Frames options
L.unitframe_subtext = "Customize player, target frames and etc."
...
L.unitframe_castbar_focus_type = "Icon for focus castbar"
L.unitframe_castbar_focus_type_icon = "Icon"
L.unitframe_castbar_focus_type_bar = "Icon with bar"
...
L.raidframe_plugins_debuffhighlight = "Show texture for dispellable debuff"
L.raidframe_plugins_debuffhighlight_icon = "Show dispellable debuff icon"
L.raidframe_plugins_debuffs = "Raid debuff icons (from the list)"
L.raidframe_plugins_debuffs_timer = "Timer on raid debuff icons"
L.raidframe_plugins_debuffs_filter = "Enable blizzard filters for debuffs"
...
L.raidframe_plugins_buffs = "Raid buff icons (by Blizzard filter)"
L.raidframe_plugins_buffs_timer = "Timer on raid buffs icons"
...
L.tooltip_show_shift_desc = "Show item levels and spec when Shift is pressed"
...
L.nameplate_height = "Nameplate height"
L.nameplate_width = "Nameplate width"
...
L.nameplate_show_castbar_name = "Show castbar name"
L.nameplate_cast_target = "Show name of the spell's target unit"
L.nameplate_class_icons = "Class icons in PvP"
L.nameplate_name_abbrev = "Display abbreviated names"
L.nameplate_short_name = "Replace names with short ones (from the list)"
L.nameplate_clamp = "Clamp nameplates"
L.nameplate_clamp_desc = "Clamp nameplates to the top of the screen when outside of view"
L.nameplate_track_debuffs = "Show your debuffs (from the list)"
L.nameplate_track_buffs = "Show dispellable enemy buffs and buffs from the list"
L.nameplate_auras_size = "Auras size"
L.nameplate_healer_icon = "Show icon above enemy healers"
L.nameplate_totem_icons = "Show totems icon"
L.nameplate_target_glow = "Show glow texture for target"
L.nameplate_only_name = "Show only name for friendly units"
L.nameplate_click_through = "Allow click-through on friendly names"
...
L.nameplate_good_color = "Good threat color, varies depending if your a tank or dps/heal"
L.nameplate_near_color = "Losing/Gaining threat color"
L.nameplate_bad_color = "Bad threat color, varies depending if your a tank or dps/heal"
L.nameplate_offtank_color = "Offtank threat color"
...
L.combattext_subheader_damage = "Damage and healing"
...
L.combattext_direction = "Reverse scrolling direction from top to bottom"
L_GUI_COMBATTEXT_SHORT_NUMBERS = "Use short numbers ('25.3k' instead of '25342')"
L.combattext_subheader_combat_module_top = "Information Alerts"
L.combattext_subheader_combat_module_top_extra = "For extra settings of alerts, install AdvancedInterfaceOptions addon"
...
L.minimap_on_top = "Move minimap to top right corner"
L_GUI_MINIMAP_ICON = "Tracking icon"
L_GUI_GARRISON_ICON = "Omnium Folio icon"
...
L.filger_subheader_elements = "Displayed elements"
...
L.filger_show_aura_bar_player = "Aura bars on player"
...
L.automation_subtext = "This block contains settings that facilitate the routine."
...
L.automation_minimap_zoom = "Change minimap zoom level when moving"
L.automation_reputation = "Auto track reputation gain"
...
L.enemycooldown_down = HUD_EDIT_MODE_SETTING_BAGS_DIRECTION_DOWN or "Down"
L.enemycooldown_left = HUD_EDIT_MODE_SETTING_BAGS_DIRECTION_LEFT or "Left"
L.enemycooldown_right = HUD_EDIT_MODE_SETTING_BAGS_DIRECTION_RIGHT or "Right"
L.enemycooldown_up = HUD_EDIT_MODE_SETTING_BAGS_DIRECTION_UP or "Up"

-- Pulse cooldowns options
L.pulsecooldown = "Pulse Cooldowns"
L.pulsecooldown_subtext = "Track your cd using a pulse icon in the center of the screen."
L.pulsecooldown_enable = "Show cooldowns pulse"
L.pulsecooldown_size = "Cooldowns pulse icon size"
L.pulsecooldown_sound = "Warning sound notification"
L.pulsecooldown_anim_scale = "Animation scaling"
...
L_GUI_STATS_TALENTS_DESC = "Data-text allows you to change the spec and loot on click"
...
-- Trade options
L.trade = "Trade"
L.trade_subtext = "Settings related to professions and trade"
...
L.misc_subtext = "Other settings that add interesting features."
