...
L.profile_error_lib = "Pour activer l'exportation et l'importation - installer Media_ShestakUI"
L.profile_error_code = "Erreur dans le code importé !"

-- General options
L.general_subtext = "Ces paramètres contrôlent les paramètres généraux de l’interface utilisateur. \nTapez '/uihelp' dans le chat pour obtenir de l’aide."
L.general_welcome_message = "Message de bienvenue dans le chat"
L.general_auto_scale = "Mise à l'échelle automatique de l’interface utilisateur"
L.general_uiscale = "Mettre l'interface à l'échelle \n(si 'Mise à l'échelle automatique de l’interface utilisateur' est désactivée)"
...
-- Skins options
L.skins = "Personnalisation"
L.skins_subtext = "Change l’apparence de l’interface standard."
L.skins_blizzard_frames = "Activer la personnalisation des fenêtres Blizzard"
L.skins_minimap_buttons = "Activer la personnalisation des icônes de la minimap"
L.skins_subheader = "Change l’apparence des addons"
L.skins_minimap_buttons_mouseover = "Icônes de la minimap au survol de la souris"
L.skins_bubbles = "Skin de l'infobulle"

-- Unit Frames options
L.unitframe_subtext = "Personnalisez le cadre du joueur, de la cible, etc..."
...
L.unitframe_class_bar_soul = "Activer la barre des fragments d'âme"
...
L.raidframe_plugins_debuffhighlight = "Afficher la texture de l'affaiblissement dispellable"
...
L.raidframe_plugins_debuffs_filter = "Activer les filtres Blizzard pour les affaiblissements" -- Needs review
L.raidframe_plugins_private_auras = "Auras privées de Blizzard"
L.raidframe_plugins_pvp_debuffs = "Afficher les icônes d'affaiblissement JcJ (de la liste)"
L.raidframe_plugins_buffs = "Icônes des buffs de raid (filtre Blizzard)"
L.raidframe_plugins_buffs_timer = "Délai sur les icônes de buffs de raid"
...
L.chat_second_frame = "Activer le deuxième cadre de chat sur le côté droit"
...
L.nameplate_height = "Hauteur des barres de noms"
L.nameplate_width = "Largeur des barres de noms"
...
L.nameplate_show_castbar_name = "Afficher le nom du sort"
L.nameplate_cast_target = "Afficher le nom de la cible du sort"
L.nameplate_class_icons = "Icône de classe en JcJ"
L.nameplate_name_abbrev = "Afficher les noms abrégés"
...
L.nameplate_track_debuffs = "Afficher vos debuffs (de la liste)"
L.nameplate_track_buffs = "Afficher les buffs et debuffs ennemis dissipables (de la liste)"
L.nameplate_auras_size = "Taille des debuffs"
L.nameplate_healer_icon = "Affiche une icône de soigneur sur les barres ennemis dans les champs de bataille"
...
L.nameplate_good_color = "Bonne couleur de menace, dépend de si vous êtes un tank ou dps/heal"
L.nameplate_near_color = "Perte/Gain de couleur de menace"
L.nameplate_bad_color = "Mauvaise couleur de menace, dépend de si vous êtes un tank ou dps/heal"
L.nameplate_offtank_color = "Coloration de la menace du tank secondaire"
...
L.nameplate_mob_color_alt = "Deuxième couleur pour les créatures"
L.nameplate_mob_color_list = "Liste des créatures"
...
L.combattext_subheader_damage = "Dommages et guérison"
...
L.combattext_direction = "Changer la direction de défilement de bas en haut"
L_GUI_COMBATTEXT_SHORT_NUMBERS = "Rendre plus lisible les nombres ('25.3k' au lieu de '25342')"
L.combattext_subheader_combat_module_top = "alertes d'information"
L.combattext_subheader_combat_module_top_extra = "Pour des paramètres supplémentaires d’alertes, installez l'addon AdvancedInterfaceOptions"
...
L.aura_player_buff_mouseover = "Au survol de la souris"
...
L_GUI_GARRISON_ICON = "Icône de Feuillet de l’Omnium"
...
L.filger_show_aura_bar_player = "Barres d'aura sur le joueur"
...
L.automation_subtext = "Ce bloc contient des paramètres qui facilitent la routine."
...
L.automation_minimap_zoom = "Ajuster le zoom de la minicarte lors des déplacements"
L.automation_reputation = "Suivi automatique des gains de réputation"
...
-- Trade options
L.trade = "Métier"
L.trade_subtext = "Paramètres liés aux professions et aux métiers"
...
L.misc_subtext = "Paramètres qui ajoutent des fonctionnalités intéressantes."
