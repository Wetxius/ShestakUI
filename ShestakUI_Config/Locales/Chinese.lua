...
-- General options
L.general_subtext = "一般用戶界面设置，键入 /uihelp 获取更多可用命令。"
L.general_welcome_message = "欢迎信息"
L.general_auto_scale = "自动UI缩放"
L.general_uiscale = "自定义UI缩放"
...
-- Skins options
L.skins = "界面美化"
L.skins_subtext = "对游戏默认界面和单体插件界面进行美化"
L.skins_blizzard_frames = "美化暴雪默认界面"
L.skins_minimap_buttons = "小地图插件图标"
L.skins_subheader = "单体插件"
L.skins_minimap_buttons_mouseover = "鼠标悬停显示插件图标"
L.skins_bubbles = "美化聊天泡泡"

-- Unit Frames options
L.unitframe_subtext = "定制玩家/目标框架/其他框架"
...
L.unitframe_class_bar_soul = "灵魂碎片(恶魔猎手)"
...
L.raidframe_plugins_debuffhighlight = "可驱散时高亮"
...
L.nameplate_show_castbar_name = "法术名称"
L.nameplate_cast_target = "显示法术目标的名称" -- Needs review
L.nameplate_class_icons = "PvP时显示职业图标"
L.nameplate_name_abbrev = "名字缩写"
L.nameplate_short_name = "替换名称"
L.nameplate_clamp = "贴边显示"
L.nameplate_clamp_desc = "当单位姓名板超出屏幕时仍贴边显示"
L.nameplate_track_debuffs = "显示DeBuff(需要关闭名字缩写)"
L.nameplate_track_buffs = "显示可进攻驱散"
L.nameplate_auras_size = "图标大小"
L.nameplate_healer_icon = "战场中显示治疗职业图标"
...
L.nameplate_good_color = "安全仇恨颜色"
L.nameplate_near_color = "临界仇恨颜色"
L.nameplate_bad_color = "危险仇恨颜色"
L.nameplate_offtank_color = "副坦仇恨颜色"
L.nameplate_extra_color = "易爆/怨毒词缀颜色"
L.nameplate_mob_color_enable = "副本中重要小怪着色"
L.nameplate_mob_color = "小怪颜色"
L.nameplate_mob_color_alt = "小怪颜色二"
L.nameplate_mob_color_list = "重要小怪名单"
...
L_GUI_GARRISON_ICON = "圣所报告图标" -- Needs review
...
L.filger_show_aura_bar_player = "玩家Buff计时条"
...
L.automation_minimap_zoom = "按移速更改小地图的缩放级别"
L.automation_reputation = "自动追踪声望"
...
L.pulsecooldown = "技能冷却闪烁"
L.pulsecooldown_subtext = "显示在屏幕中央"
L.pulsecooldown_enable = "技能冷却闪烁提示"
L.pulsecooldown_size = "技能冷却闪烁大小"
L.pulsecooldown_sound = "播放声音提醒"
L.pulsecooldown_anim_scale = "动画缩放"
L.pulsecooldown_hold_time = "持续时间"
