...
-- General options
L.general_subtext = "Эти настройки контролируют общие параметры UI. Наберите в чат '/uihelp' для помощи."
L.general_welcome_message = "Приветственное сообщение в чате"
L.general_auto_scale = "Автоматически масштабировать интерфейс"
L.general_uiscale = "Масштаб интерфейса"
...
-- Skins options
L.skins = "Стилизация"
L.skins_subtext = "Изменение внешнего вида стандартного интерфейса."
L.skins_blizzard_frames = "Стилизация элементов интерфейса Blizzard"
L.skins_minimap_buttons = "Стилизация кнопок модификаций у миникарты"
L.skins_subheader = "Стилизация сторонних модификаций"
L.skins_minimap_buttons_mouseover = "Кнопки по наведению курсора"
L.skins_bubbles = "Стилизация облачков чата"

-- Unit Frames options
L.unitframe_subtext = "Настройка рамок игрока, цели и т.д."
...
L.raidframe_plugins_private_auras = "'Приватные ауры' Blizzard"
...
L.nameplate_height = "Высота индикатора"
L.nameplate_width = "Ширина индикатора"
...
L.nameplate_show_castbar_name = "Название заклинания"
L.nameplate_cast_target = "Отображать цель заклинания"
L.nameplate_class_icons = "Иконки классов в PvP"
L.nameplate_name_abbrev = "Сокращение имен"
L.nameplate_short_name = "Заменить имена на короткие (из списка)"
...
L.nameplate_track_debuffs = "Отображать ваши отрицательные эффекты (из списка)"
L.nameplate_track_buffs = "Отображать снимаемые баффы + из списка"
L.nameplate_auras_size = "Размер иконок аур"
L.nameplate_healer_icon = "Иконка над вражескими целителями"
...
L.nameplate_good_color = "Цвет наименьшей угрозы (для танка наивысшей)"
L.nameplate_near_color = "Цвет получения/сброса угрозы"
L.nameplate_bad_color = "Цвет наивысшей угрозы (для танка наименьшей)"
L.nameplate_offtank_color = "Цвет угрозы для оффтанка (если вы танк)"
...
L_GUI_GARRISON_ICON = "Иконка Фолианта омниума"
...
L.filger_show_aura_bar_player = "Полосы аур на игроке"
...
L.automation_subtext = "В этом блоке расположены настройки, которые облегчают рутину."
...
L.automation_minimap_zoom = "Менять масштаб миникарты при движении"
L.automation_reputation = "При получении очков репутации отслеживать фракцию"
...
-- Trade options
L.trade = "Торговля"
L.trade_subtext = "Настройки связанные с профессиями и торговлей."
...
L.misc_subtext = "Прочие настройки, которые добавляют интересные возможности."
